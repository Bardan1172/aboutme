      ...
      <section className="snap-start h-screen flex flex-col md:flex-row items-center justify-center p-6 md:p-24 relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1200px] flex flex-col md:flex-row items-center gap-16 md:gap-24">
          ...
          <div className="relative w-72 h-72 md:w-[450px] md:h-[450px] flex-shrink-0 order-1 md:order-2 group">
            {/* Glow Effect */}
            <div className="absolute -inset-4 bg-blue-600/10 rounded-full blur-3xl opacity-50 group-hover:opacity-100 transition-opacity duration-1000"></div>
            
            <div className="relative w-full h-full rounded-full border-[1px] border-zinc-800 p-4 md:p-6 bg-zinc-900/20 backdrop-blur-3xl">
               <div className="w-full h-full rounded-full overflow-hidden border border-zinc-700/50 shadow-2xl bg-black">
                  <video 
                    autoPlay 
                    loop 
                    muted 
                  ...
                  >
                    ...
                    <img src="/foto/foto-profile.jpg" alt="Bardan Profile" className="w-full h-full object-cover" />
                  </video>
               </div>
               
               {/* Badge Live */}
               <div className="absolute top-10 right-10 bg-red-600 text-white text-[8px] font-black px-3 py-1 rounded-full tracking-[0.2em] animate-pulse shadow-lg shadow-red-600/40 z-20">
                  LIVE
               </div>
            </div>
          </div>
      ...
      <section className="snap-start h-screen flex flex-col items-center justify-center p-8 relative">
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/50 p-10 md:p-14 rounded-[50px] backdrop-blur-2xl">
            <p className="text-2xl md:text-4xl leading-tight text-white font-light text-justify tracking-tighter italic">
              "Seorang kreator yang bertumbuh di persimpangan kreativitas digital dan teknologi. Fokus saya adalah membangun komunitas yang inklusif serta solusi web yang performan."
            </p>
          </div>
        </div>
      </section>
