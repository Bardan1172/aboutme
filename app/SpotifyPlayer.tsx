...
export default function SpotifyPlayer() {
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      {/* Container Utama - Background Gelap dengan Gradient Hijau di Kanan (sesuai gambar) */}
      <div className="relative overflow-hidden bg-[#121212] rounded-3xl border border-zinc-800 shadow-2xl p-6 md:p-12 flex flex-col md:flex-row items-center gap-10">
        ...
        {/* Glow Effect Hijau di Pojok Kanan Atas */}
        ...
        <div className="flex-1 z-10 text-center md:text-left">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-2 hover:underline cursor-pointer">
            Dan...
          </h2>
          <p className="text-lg md:text-xl text-zinc-400 mb-10">Sheila On 7</p>

          {/* Progress Bar (Custom UI) */}
        ...
        {/* Bagian Tengah: Album Art (Mirip di Screenshot) */}
        ...
        <div className="flex flex-col gap-6 text-zinc-400 z-10">
          ...
          <button className="hover:text-[#1DB954] transition"><CheckIcon /></button>
        </div>

        {/* Iframe Tersembunyi (Untuk Playback) */}
        {/* Kita sembunyikan playernya tapi suaranya tetap bisa diputar jika linknya tepat */}
        <div className="absolute bottom-0 left-0 opacity-0 pointer-events-none">
          <iframe
